...
class UpdateExamDTO(BaseModel):
    ...
    name: str | None = Field(None, min_length=4, max_length=150, examples=["XL Exame de Ordem Unificado"])
    edition: int | None = Field(None, gt=0, examples=[40])
    year: int | None = Field(None, ge=2000, le=2100, examples=[2024])
    board: str | None = Field(None, min_length=2, max_length=100, examples=["FGV"])
